...
```shell
composer require jascha030/dependency-injection
```
...
```shell
composer require --no-dev jascha030/dependency-injection
```
...
the [MIT License](https://github.com/jascha030/dependency-injection/blob/master/LICENSE.md)
